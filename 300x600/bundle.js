    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          tl.from('#txt-wraper-1', 0.5, {
            x: '+=20',
            autoAlpha: 0,
            ease: 'circ.out'
          }, '<0.25').from('#icon-1-a', 1, {
            drawSVG: 0
          }, '<50%').from('#vector-line', 1, {
            drawSVG: 0
          }, '>0.75').to('#txt-wraper-1', 0.5, {
            x: '-=20',
            autoAlpha: 0,
            ease: 'circ.in'
          }, '<').to('#lines-wraper', 1, {
            x: '-=300'
          }, '<').from(['#icon-2-a', '#icon-2-b', '#icon-2-c', '#icon-2-d', '#icon-2-e', '#icon-2-f'], 0.6, {
            drawSVG: 0
          }, '<75%').from('#txt-wraper-2', 0.5, {
            x: '+=20',
            autoAlpha: 0,
            ease: 'circ.out'
          }, '<30%').from('#cta', {
            ...
            x: '-=300'
          }, '>0.75').from('#vector-line-2', 1, {
            drawSVG: 0
          }, '<').to('#txt-wraper-2', 0.5, {
            x: '-=20',
            autoAlpha: 0,
            ease: 'circ.in'
          }, '<').from(['#vector-phone', '#vector-phone-a', '#vector-phone-b', '#rectangle'], 0.6, {
            drawSVG: 0
          }, '<75%').from('#txt-wraper-3', 0.5, {
            x: '+=20',
            autoAlpha: 0,
            ease: 'circ.out'
          }, '<30%');
